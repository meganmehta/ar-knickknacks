...
public class Weather2 : MonoBehaviour
{
    public GameObject weatherTextObject;
       ...
       string url = "http://api.openweathermap.org/data/2.5/weather?lat=28.4&lon=-80.6&APPID=aeba8a3c07b4cb4c2e7040a4eb3190a6&units=metric";
    ...
    IEnumerator GetRequest(string uri)
    {
        using (UnityWebRequest webRequest = UnityWebRequest.Get(uri))
        {
            ...
            else
            {
				...
				int cels = Mathf.RoundToInt((float)tempF);
                ...
                weatherTextObject.GetComponent<TextMeshPro>().text = "" + cels.ToString() + "°C\n" + conditions;
            }
        }
    }
}
